...
- **集团课程专业课程支持**：集团课程下新增专业课程(图文)子tab，自动切换视频课程/专业课程双tab刷分
- **推荐回退专业课程**：推荐页全部已学习时自动回退到集团课程-专业课程(图文)，不再死循环等待
- **子tab优先级配置**：新增 `jituan_priority` 配置项，设置面板可选「专业课程(图文)优先」或「视频课程优先」，默认图文优先
